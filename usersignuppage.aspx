<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="usersignuppage.aspx.cs" Inherits="ELibraryManagment.usersignuppage" %>
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Date of Brrth"
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-4">
                        <label> Pincode</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox9" runat="server" placeholder="Pincode"

<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Admin_managment.aspx.cs" Inherits="ELibraryManagment.Admin_managment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="container-fluid">
      <div class="row">
          ...
          <!--Admin managment details side code start -->
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                            <img width="100px" src="all%20images/images/generaluser.png" />
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                       <div class="col-md-4">
                           <label>State</label>
                           <div class="form-group">
                               <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="State" TextMode="SingleLine" ReadOnly="True"></asp:TextBox>
                           </div>
                       </div>
                       <div class="col-md-4">
                           <label>City</label>
          ...
          <!--Admin management  side code end-->

          <!--Publisher List side code Start-->
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="member_id" DataSourceID="SqlDataSource1">
                         ...
                         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:E-Library DBConnectionString2 %>" ProviderName="<%$ ConnectionStrings:E-Library DBConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM [member_master_table]"></asp:SqlDataSource>
                     </div>
                  </div>
               </div>
            </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Admin_bookinventry.aspx.cs" Inherits="ELibraryManagment.Admin_bookinventry" %>
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox7" runat="server" placeholder="Issued Book" TextMode="Number" ></asp:TextBox>
                        </div>
                     </div>
                  </div>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:E-Library DBConnectionString %>" SelectCommand="SELECT * FROM [book_master_tbl]"></asp:SqlDataSource>
                     <div class="col">

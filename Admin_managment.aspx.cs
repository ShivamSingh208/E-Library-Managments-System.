...
{
    public partial class Admin_managment : System.Web.UI.Page
    {
        ...
        void deleteMemberByID()
        {
            if (TextBox2.Text.Trim().Equals(" "))
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("DELETE from member_master_table WHERE member_id='" + TextBox2.Text.Trim() + "'", con);

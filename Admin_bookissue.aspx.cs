    ...
    public partial class Admin_bookissue : System.Web.UI.Page
    {
        ...
        bool checkIfIssueEntryExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from book_issue_table WHERE member_id='" + TextBox2.Text.Trim() + "' AND book_id='" + TextBox3.Text.Trim() + "'", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
        ...
        void issueBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_issue_table(member_id,member_name,book_id,book_name,issue_date,due-date) values(@member_id,@member_name,@book_id,@book_name,@issue_date,@due-date)", con);
                ...
                cmd.Parameters.AddWithValue("@due-date", TextBox6.Text.Trim());
        ...
        void returnBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Delete from book_issue_table WHERE book_id='" + TextBox3.Text.Trim() + "' AND member_id='" + TextBox2.Text.Trim() + "'", con);
